...
```sh
gcloud builds submit --tag gcr.io/projetdbt-450020/scraper-job-vinci
```
...
```sh
gcloud run jobs create scraper-job-vinci \
    --image=gcr.io/projetdbt-450020/scraper-job-vinci \
    --region=us-central1 \
    --task-timeout=1800s \
    --max-retries=3 \
