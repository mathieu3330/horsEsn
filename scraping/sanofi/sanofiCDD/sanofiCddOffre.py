...
# URL pour les contrats CDD
BASE_URL_CDD = "https://jobs.sanofi.com/fr/search-jobs/results?ActiveFacetID=Marketing+%26+Sales&CurrentPage={}&RecordsPerPage=15&TotalContentResults=&Distance=50&RadiusUnitType=0&Keywords=&Location=&ShowRadius=False&IsPagination=False&CustomFacetName=&FacetTerm=&FacetType=0&FacetFilters%5B0%5D.ID=3017382&FacetFilters%5B0%5D.FacetType=2&FacetFilters%5B0%5D.Count=2&FacetFilters%5B0%5D.Display=France&FacetFilters%5B0%5D.IsApplied=true&FacetFilters%5B0%5D.FieldName=&FacetFilters%5B1%5D.ID=Fixed+Term&FacetFilters%5B1%5D.FacetType=5&FacetFilters%5B1%5D.Count=2&FacetFilters%5B1%5D.Display=Fixed+Term&FacetFilters%5B1%5D.IsApplied=true&FacetFilters%5B1%5D.FieldName=job_type&SearchResultsModuleName=Search+Results&SearchFiltersModuleName=Search+Filters&SortCriteria=0&SortDirection=0&SearchType=5&PostalCode=&ResultsType=0&fc=&fl=&fcf=&afc=&afl=&afcf=&TotalContentPages=NaN"
...
# Fonction principale de scraping pour CDD
def scrape_sanofi_cdd():
    page = 1
    stop_scraping = False

    while not stop_scraping:
        url = BASE_URL_CDD.format(page)
